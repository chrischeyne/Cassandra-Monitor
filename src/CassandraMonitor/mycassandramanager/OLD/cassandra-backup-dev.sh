...
CASSBACKUP='/home/cassandra-backup-dev'
...
scp -P48522 -p /home/cassandra-backup-dev/* root@212.42.14.27:/home/cassandra-backup-dev/
...
$MAIL -s "`hostname -s`-Cassandra-Backup" chris.cheyne@hearst.co.uk < $CASSTEXT
